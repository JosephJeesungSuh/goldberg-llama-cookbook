...
class personality_dataset:
    ...
    #     "SURGENCY":            "Question: Here is a characteristic that may or may not apply to you. Please respond the extent to which you agree or disagree with the following statement. Statement: I see myself as someone who is extraverted.",
    #     "AGREEABLENESS":       "Question: Here is a characteristic that may or may not apply to you. Please respond the extent to which you agree or disagree with the following statement. Statement: I see myself as someone who is agreeable.",
    #     "CONSCIENTIOUSNESS":   "Question: Here is a characteristic that may or may not apply to you. Please respond the extent to which you agree or disagree with the following statement. Statement: I see myself as someone who is conscientious.",
    #     "EMOTIONAL_STABILITY": "Question: Here is a characteristic that may or may not apply to you. Please respond the extent to which you agree or disagree with the following statement. Statement: I see myself as someone who is emotionally stable.",
    #     "INTELLECT":           "Question: Here is a characteristic that may or may not apply to you. Please respond the extent to which you agree or disagree with the following statement. Statement: I see myself as someone who is open to experience."
    # }

...
def get_custom_dataset(dataset_config, tokenizer, split: str, trait: str, tone: str, use_negative_essay: bool):
    ...
    try:
        return getattr(module, func_name)(dataset_config, tokenizer, split, trait, tone, use_negative_essay)
